...
import panda.di.utils.DependencyInjectionUtils;
...
public interface Resources {
    ...
    /**
     * Create bind for parameters annotated with the specified annotation tested by the {@link DependencyInjectionUtils#testAnnotation(Class)} method
     *
     * @param annotation the annotation to bind
     * @param <A> type of annotation
     * @return the bind based on associated annotation
